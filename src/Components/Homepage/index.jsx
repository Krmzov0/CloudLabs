...
import { ArrowCircleRight, Laptop, ChartLineUp, PenNib, FacebookLogo, InstagramLogo, TwitterLogo, DeviceMobile } from "phosphor-react";
...
function Homepage() {
    ...
    return (
        <>
            <Header />
            <div className='hero container mx-auto relative top-36 flex justify-center'>
                <div className='h1CON flex flex-col w-[77%] justify-center'>

                    <div className='w-full flex'>
                        <motion.div variants={H1Animation} initial="initial" animate="animate" ><h1 className='flex items-center text-[2.5rem] sm:text-9xl ml-2 sm:ml-0 text-[#f7f7f7] w-max'>Think beyond
                            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.35 }}><LazyLoad><img src={circleText} className='h-12 ml-4 w-12 sm:h-36 sm:ml-10 sm:w-36 rotating' alt="" /></LazyLoad></motion.div></h1></motion.div>
                    </div>

                    <motion.div variants={H1Animation2} initial="initial" animate="animate"  ><div className='w-full flex items-center justify-end mt-2 sm:mt-3'>
                        <motion.div transition={{
                            ...
                            whileTap={{
                                y: 2.5
                            }}><div className='mr-2 sm:mr-6 cursor-pointer w-[9rem] sm:w-96 h-9 sm:h-24 flex mb-2 sm:mb-0 justify-center items-center rounded-full bg-[#b5d43b] hover:w-[27rem] transition-all relative top-1 ml-4 hover:border-4 sm:hover:border-8 hover:border-[#f7f7f7a1]'><h2 className='text-md mx-0 sm:mx-3 sm:text-4xl text-[#1c1c1c]'>CLOUD</h2><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-up-right" width="48" height="48" viewBox="0 0 24 24" stroke-width="1.2" stroke="#1c1c1c" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <line x1="17" y1="7" x2="7" y2="17" />
                                <polyline points="8 7 17 7 17 16" />
                            </svg><h2 className='text-md mx-0 sm:mx-3 sm:text-4xl text-[#1c1c1c]'>LABS</h2></div></motion.div>
                        <h1 className='z-40 relative text-[2.5rem] sm:text-9xl text-[#f7f7f7] w-max select-none '>the<span className='text-[#b5d43b] ml-5 H1clouds'>clouds</span>.</h1>

                    </div></motion.div>
                </div>
            </div>

            <div className='heroText flex justify-between items-end container mx-auto relative top-32 sm:top-72'>
                <div className='grid justify-between items-center heroCTA relative top-7 sm:top-0'>
                    <div className='flex items-center justify-between w-[19rem] mb-8 buttonContainer'>
                        <div>
                            <motion.div transition={{
                                ...
                                whileTap={{
                                    y: 2.5
                                }}><button className='border-2 border-[#f7f7f7] px-7 sm:px-5 py-2 w-max text-[#f7f7f7] flex text-md sm:text-xl font-medium items-center rounded-full bg-transparent hover:bg-[#f7f7f7] hover:text-[#252525] transition-all'>Get in touch</button></motion.div>
                        </div>
                        ...
                        <div>
                            <motion.div transition={{
                                ...
                                whileTap={{
                                    y: 2.5
                                }}><Link to='/about'><button className=' px-10 py-2 w-max text-[#252525] flex text-md sm:text-xl font-medium items-center rounded-full bg-[#b5d43b] hover:border-2 hover:border-[#f7f7f7d4]'>
                                    ABOUT
                ...
                <motion.div initial={{ scaleY: 0, originY: 'bottom' }} animate={{ scaleY: 1 }} transition={{
                    ...
                    delay: 0.3
                        ...
                        <div className='heroP'>
                            <motion.div initial={{ y: 70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.6 }}><h2 className='text-xl font-medium text-right relative mb-3 text-[#b5d43b] tracking-[1px]'>WHO WE ARE</h2></motion.div>
                            <p className='relative text-right font-light text-[1.55rem] text-[#f7f7f7d7]'><motion.div initial={{ y: 70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.65 }}>We are Digital Creators.</motion.div>  <motion.div initial={{ y: 70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.75 }}>Our Services offer Web Development,</motion.div> <motion.div initial={{ y: 70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.85 }}> Social Media Marketing  & Graphic Design</motion.div></p>
                        </div>
                    </div></motion.div>
            </div>

            <div className='container mx-auto relative top-[32rem] flex flex-col justify-center items-center d'>
            ...
            <LazyLoad >
                <div className='whatWeDo container grid mx-auto relative top-[50rem]'>
                    ...
                    <div className='whatWeDoContainer container mt-12 flex flex-wrap gap-y-3 justify-start items-center gap-x-3'>
                        <motion.div variants={WhatWeDo} initial="hidden" animate={whatWeDoControls} transition={{ delay: 0.4 }} ><div className='whatWeDoCard w-80 rounded-2xl h-96 p-8 py-10 bg-[#f7f7f7] flex items-stretch justify-start'>
                        ...
                        <motion.div variants={WhatWeDo} initial="hidden" animate={whatWeDoControls} transition={{ delay: 0.55 }} ><div className='whatWeDoCard w-80 rounded-2xl h-96 p-8 py-10 bg-[#b5d43b] flex items-stretch justify-start'>
                            <div className='flex flex-col justify-between items-stretch cursor-pointer w-full'>
                                ...
                                <div className='self-start '>
                                    ...
                                    <h1 className='n text-3xl font-regular text-[#252525] uppercase'>Social Media<br /> Marketing</h1>
                                </div>
                            </div>
                        </div></motion.div>

                        <motion.div variants={WhatWeDo} initial="hidden" animate={whatWeDoControls} transition={{ delay: 0.7 }} ><div className='whatWeDoCard w-80 rounded-2xl h-96 p-8 py-10 bg-[#f7f7f7] flex items-stretch justify-start'>
                            <div className='flex flex-col justify-between items-stretch cursor-pointer w-full'>
                        ...
                        <motion.div variants={WhatWeDo} initial="hidden" animate={whatWeDoControls} transition={{ delay: 0.8 }} ><div className='whatWeDoCard w-80 rounded-2xl h-96 p-8 py-10 bg-[#b5d43b] flex items-stretch justify-start'>
                            <div className='flex flex-col justify-between items-stretch cursor-pointer w-full'>

                                <div className='flex justify-between items-center'>
                                    <DeviceMobile size={46} color="#252525" weight="light" />
                                    <ArrowCircleRight size={46} color="#252525" weight="light" className='cardArrow' />
                                </div>

                                <div className='self-start'>
                                    <h4 className='mb-3 text-2xl font-semibold text-[#252525]'>04.</h4>
                                    <h1 className='n text-3xl font-regular text-[#252525] uppercase'>Mobile App <br /> Development</h1>
                                </div>
                            </div>
                        </div></motion.div>
                    </div>
